...
layout = [
    [sg.Text("DATA SISWA BARU", background_color="grey", text_color="black", size=(20,1), justification="center")],
    ...
    [sg.Button("Hapus", button_color=("white", "black")), sg.Button("Simpan", button_color=("white", "black"))]
]
